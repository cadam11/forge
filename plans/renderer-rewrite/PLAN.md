...
| Native-menu bridge (≈20 channels, `preload/src/index.ts:394-441`)                             | 391           | **MUST**   | All 34 `menu.on*` subscriptions must land somewhere real, including the 3 currently broken ones (0.1).                                                                                     |
...
`menu.on*` bridge (all 34 channels, including the 3 broken ones from 0.1, routed through the
