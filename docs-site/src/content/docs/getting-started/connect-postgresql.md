...
| `ssl: profile.encrypt ? { rejectUnauthorized: !profile.trustServerCertificate } : false` | `packages/main/src/services/sql/provider/pg-provider.ts:32`                                                                             |
...
| `max: 10`, `idleTimeoutMillis: 30000`                                                    | `packages/main/src/services/sql/provider/pg-provider.ts:35-36`                                                                          |
