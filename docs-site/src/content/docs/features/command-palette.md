...
owns it. Four commands are in this state today: _Server properties_, _Database properties_,
_Object properties_ and the database _Delete_ confirmation.
...
| Four commands are unowned today                                                    | `packages/renderer/src/commands/registry.ts:387, 404, 471-473`, and no `useCommand` for them             |
