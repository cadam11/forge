...
OpenRouter alone. It applies to nothing else that vendor offers, and _Provider default_ is a
distinct instruction rather than a synonym for the cheapest band.
...
| "Provider default" is a distinct instruction                       | `packages/renderer/src/features/ai-setup/ai-setup-dialog.tsx:103-107, 126`                                           |
