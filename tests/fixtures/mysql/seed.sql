-- Deterministic seed data for the regression fixture (MySQL).
-- 10 products, 5 customers, 8 orders, 15 order items.

INSERT INTO products (sku, name, price_cents, category, active) VALUES
  ('SKU-LAPTOP-01',  'MacBook Air M4',                           119900, 'electronics', 1),
  ('SKU-LAPTOP-02',  'MacBook Pro 14',                           199900, 'electronics', 1),
  ('SKU-PHONE-01',   'iPhone 16',                                 79900, 'electronics', 1),
  ('SKU-PHONE-02',   'iPhone 16 Pro',                             99900, 'electronics', 1),
  ('SKU-BOOK-01',    'Designing Data-Intensive Applications',      4499, 'books',       1),
  ('SKU-BOOK-02',    'The Pragmatic Programmer',                   3999, 'books',       1),
  ('SKU-COFFEE-01',  'Espresso Machine',                          89900, 'kitchen',     1),
  ('SKU-COFFEE-02',  'Coffee Grinder',                            14900, 'kitchen',     1),
  ('SKU-DESK-01',    'Standing Desk',                             49900, 'furniture',   1),
  ('SKU-CHAIR-01',   'Ergonomic Chair',                           39900, 'furniture',   0);
