/**
 * Ported verbatim from `packages/renderer/src/app/core/state/explorer-folders.spec.ts` — only
 * the import path changed. The helpers are pure, so there was nothing Angular-shaped to
 * rewrite.
 */
